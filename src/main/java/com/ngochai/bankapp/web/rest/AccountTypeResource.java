...
/**
 * REST controller for managing {@link com.ngochai.bankapp.domain.AccountType}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AccountTypeResource {
        ...
        Optional<AccountType> result = accountTypeRepository
            ...
            .map(existingAccountType -> {
                ...
                if (accountType.getInterestRate() != null) {
                    existingAccountType.setInterestRate(accountType.getInterestRate());
                }
    ...
    public ResponseEntity<List<AccountType>> getAllAccountTypes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        ...
        Page<AccountType> page = accountTypeRepository.findAll(pageable);
