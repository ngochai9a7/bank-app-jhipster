...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loan-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOANTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANTYPE actions', async () => {
      const expectedActions = [
        {
