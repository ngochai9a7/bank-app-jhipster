    ...
    <Row>
      <Col md="8">
        <h2 data-cy="transactionTypeDetailsHeading">
          <Translate contentKey="bankappApp.transactionType.detail.title">TransactionType</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="bankappApp.transactionType.name">Name</Translate>
            </span>
          </dt>
