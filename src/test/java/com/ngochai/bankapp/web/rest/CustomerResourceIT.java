...
import com.ngochai.bankapp.domain.Customer;
import com.ngochai.bankapp.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_PASSHASH = "AAAAAAAAAA";
    private static final String UPDATED_PASSHASH = "BBBBBBBBBB";
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getPasshash()).isEqualTo(DEFAULT_PASSHASH);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].passhash").value(hasItem(DEFAULT_PASSHASH)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.passhash").value(DEFAULT_PASSHASH))
    ...
    void putExistingCustomer() throws Exception {
        ...
        assertThat(testCustomer.getPasshash()).isEqualTo(UPDATED_PASSHASH);
